...
| 6 | Reproducible build | Build manifest (commit, configs, toolchain, versions, SHA-256) per image; two independent CI builds of one commit produce identical artifacts | IN PROGRESS | [phase 06 report](test-reports/phase-06.md) |
