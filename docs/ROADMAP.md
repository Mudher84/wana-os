...
| 5 | UEFI boot with bootloader | GRUB (x86_64-efi) on an EFI System Partition boots kernel + rootfs in QEMU+OVMF (no `-kernel` shortcut) | IN PROGRESS | [phase 05 report](test-reports/phase-05.md) |
