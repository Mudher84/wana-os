...
| 11 | Desktop shell MVP; first the text stack with Arabic ([decision 0002](decisions/0002-text-stack.md), [phase 11 report](test-reports/phase-11.md)): text steps 1 (pinned fonts) and 2 (shaping + BiDi) PASS; step 3 (layout) in CI | IN PROGRESS |
