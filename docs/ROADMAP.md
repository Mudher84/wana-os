...
| 2 | Build environment | Pinned Buildroot fetched and verified; defconfig round-trips; CI builds the cross toolchain and a C/C++ smoke test passes | IN PROGRESS | [phase 02 report](test-reports/phase-02.md) |
