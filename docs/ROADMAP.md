...
| 7 | DRM/KMS | `[DRM]` discovers device and connector, sets mode in QEMU virtio-gpu; screenshot pixels verified | IN PROGRESS | [phase 07 report](test-reports/phase-07.md) |
